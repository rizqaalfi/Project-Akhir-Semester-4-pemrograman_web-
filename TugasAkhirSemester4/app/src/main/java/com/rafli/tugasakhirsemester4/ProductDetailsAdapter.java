...
public class ProductDetailsAdapter extends FragmentPagerAdapter {
    ...
    public ProductDetailsAdapter(FragmentManager fm, int totalTabs, String productDesc, String productOtherDetails, List<ProductSpecificationModel> productSpecificationModelList) {
        super(fm);
