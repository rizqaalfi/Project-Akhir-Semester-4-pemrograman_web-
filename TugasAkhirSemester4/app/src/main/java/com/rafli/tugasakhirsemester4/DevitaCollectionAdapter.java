...
public class DevitaCollectionAdapter extends RecyclerView.Adapter {

    private List<DevitaCollectionModel> DevitaCollectionModelList;
    ...
    public int getItemViewType(int position) {
        ...
        switch (DevitaCollectionModelList.get(position).getType()){
            case 0:
                return DevitaCollectionModel.BANNER_SLIDER;
            case 1:
                return DevitaCollectionModel.STRIP_AD_BANNER;
            case 2:
                return DevitaCollectionModel.HORIZONTAL_PRODUCT_VIEW;
            case 3:
                return DevitaCollectionModel.GRID_PRODUCT_VIEW;
            default:
                return -1;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case DevitaCollectionModel.BANNER_SLIDER:
                View BannerSliderview= LayoutInflater.from(parent.getContext()).inflate(R.layout.sliding_ad_layout,parent,false);
                return new BannerSliderViewHolder(BannerSliderview);
            case DevitaCollectionModel.STRIP_AD_BANNER:
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (DevitaCollectionModelList.get(position).getType()){
            case DevitaCollectionModel.BANNER_SLIDER:
                List<SliderModel> sliderModelList=DevitaCollectionModelList.get(position).getSliderModelList();
                ((BannerSliderViewHolder) holder).setBannerSliderViewPager(sliderModelList);
                break;
            case DevitaCollectionModel.STRIP_AD_BANNER:
                String resource=DevitaCollectionModelList.get(position).getResource();
                String color=DevitaCollectionModelList.get(position).getBackgroundColor();
                ((StripAdBannerViewHolder)holder).StripAd(resource,color);
                break;
            case DevitaCollectionModel.HORIZONTAL_PRODUCT_VIEW:
                String title=DevitaCollectionModelList.get(position).getTitle();
                String colorr=DevitaCollectionModelList.get(position).getBackgroundColor();
                List<HorizontalProductScrollModel> horizontalProductScrollModelList=DevitaCollectionModelList.get(position).getHorizontalProductScrollModelList();
                List<WishlistModel> viewAllProductList=DevitaCollectionModelList.get(position).getViewAllProductList();
                ...
                break;
            case DevitaCollectionModel.GRID_PRODUCT_VIEW:
                String gridcolorr=DevitaCollectionModelList.get(position).getBackgroundColor();
                String gridtitle=DevitaCollectionModelList.get(position).getTitle();
                List<HorizontalProductScrollModel> gridProductScrollModelList=DevitaCollectionModelList.get(position).getHorizontalProductScrollModelList();
    ...
    public int getItemCount() {
        return DevitaCollectionModelList.size();
    }
