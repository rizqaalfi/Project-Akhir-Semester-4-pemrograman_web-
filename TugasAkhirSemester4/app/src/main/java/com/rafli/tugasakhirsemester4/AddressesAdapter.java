...
import static com.rafli.tugasakhirsemester4.MyAddressesActivity.refreshItem;
import static com.rafli.tugasakhirsemester4.ui.my_account.MyAccountFragment.MANAGE_ADDRESS;

public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.ViewHolder> {

    private List<AdressesModel> addressesModelList;
    private int MODE,preSelectedPos;
    private boolean refresh=false;
    private Dialog loadingDialog;

    public AddressesAdapter(List<AdressesModel> addressesModelList, int MODE, Dialog loadingDialog) {
