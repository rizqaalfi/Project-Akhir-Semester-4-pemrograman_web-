...
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(<?php echo base_url('assets/cust/tmart/images/bg/2.jpg') ?>) no-repeat scroll center center / cover ;">
